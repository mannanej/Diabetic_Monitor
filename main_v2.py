...
# Maybe try and get a sugar value, add it to a deque, pickle and unpickle it to use the values for an A1C
####################################################################################################################################
...
def main():
    ...
    dexcom = Dexcom(username="eddiemannan@gmail.com", password="P!glet6386") # email address
    ...
    currentTime = "Get Time From The currentDate. It's datetime"
    # This section will get the A1C value from these sugars
    # a1c = getA1C(sugars)
    a1c = glucose_reading.mg_dl
